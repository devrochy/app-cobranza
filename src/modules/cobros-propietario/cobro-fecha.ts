...
/**
 * Periodo del cobro mensual del propietario en formato YYYY-MM (UTC).
 */
 ...
 * propietario) del mes, clampeado al último día del mes cuando no lo contiene.
 */
...
/**
 * Día del mes ancla al cobro, tomado del createdAt (alta) del propietario en UTC.
 */
