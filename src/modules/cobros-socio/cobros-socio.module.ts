...
controllers: [CobrosSocioController, ConversacionesSocioController],
  providers: [CobrosSocioService, CobrosSocioJob, NotificacionesSocioService, SocioMoraService, ConversacionSocioChatService],
