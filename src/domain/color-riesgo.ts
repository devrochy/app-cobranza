 ...
 * - rojo:  atraso >= umbral de la cartera (umbral inclusivo).
 * - azul:  bajo el umbral.
 * El umbral proviene de `cartera_config.cuotas_atraso_umbral` (HU-10) en el punto
 ...
 * de cuotas vencidas; el umbral viene de cartera_config). Con ambos en 0 el
